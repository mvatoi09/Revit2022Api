...
{
    public class GetGeometryButton
    {

        public void GeometyButton(UIControlledApplication application)
        {
            ...
            PushButtonData pushButtonDataTest = new PushButtonData("GetGeometry", "Get\nGeometry",
                Assembly.GetExecutingAssembly().Location, "Revit2022Api.GetGeometry.GetGeometryBiding");

            pushButtonDataTest.ToolTip = "GetGeometryBiding";
            pushButtonDataTest.LongDescription = "GetGeometryBiding";
